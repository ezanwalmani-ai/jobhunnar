...
export const AboutPage: React.FC<AboutPageProps> = ({ navigate }) => {
  ...
  useEffect(() => {
    ...
    document.title = 'About HUNAR | Building a Better Connection Between Skills and Opportunity';
    ...
    if (metaDesc) {
      metaDesc.setAttribute(
        'content',
        'Learn about HUNAR — a dedicated skills-first career platform designed to connect verified capabilities, continuous learning, and employment opportunities into a unified ecosystem.'
      );
    }
  ...
  const faqItems = [
    {
      ...
      answer:
        'HUNAR is a skills-first talent and career platform designed to bridge the gap between proven capabilities and real employment opportunities. We provide job seekers with tools to benchmark skills, access upskilling, and apply to verified openings, while helping employers evaluate candidates based on demonstrated competencies rather than resume buzzwords.',
    },
    {
      question: 'Who is HUNAR designed for?',
      answer:
        'HUNAR serves two core groups: Job Seekers (including students, fresh graduates, and experienced professionals seeking merit-driven career advancement) and Employers (including recruiters, hiring managers, and enterprise organizations seeking verified, competent talent with clear skill signals).',
    },
    {
      question: 'What makes HUNAR different from a traditional job portal?',
      answer:
        'Traditional job portals function as static bulletin boards where unvetted resumes compete against automated keyword filters. HUNAR integrates the entire career continuum — skills evaluation, role-relevant upskilling, professional credentialing, and direct employer connection — ensuring both sides have clear, honest context before making hiring decisions.',
    },
    {
    ...
    {
      question: 'How does HUNAR support Job Seekers?',
      answer:
    ...
    {
      question: 'How does HUNAR support Employers?',
      answer:
    ...
    {
      question: 'Does HUNAR provide learning and upskilling?',
      answer:
    ...
    {
      question: 'How are jobs added to HUNAR?',
      answer:
        'Every job published on HUNAR is created directly by verified employer partners or platform moderators with defined role requirements, confirmed compensation details, and active hiring intent. We do not aggregate scraped, unvetted web postings.',
    },
  ];

  return (
    <div id="hunar-about-page" className="min-h-screen bg-white text-slate-900 selection:bg-emerald-200 selection:text-emerald-950">
      {/* ========================================================================= */}
      ...
      <section
        ...
        className="relative overflow-hidden bg-gradient-to-b from-[#062e22] via-[#093527] to-[#0d4131] text-white pt-14 pb-20 sm:pt-20 sm:pb-28"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto space-y-5">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-950/80 border border-emerald-500/30 text-emerald-300 text-xs font-semibold shadow-xs">
              ...
              <span>About HUNAR &bull; Company &amp; Philosophy</span>
            </div>
            ...
            <p className="text-sm sm:text-base lg:text-lg text-emerald-100/90 leading-relaxed font-normal max-w-2xl mx-auto">
              HUNAR is built around a simple idea: people should have better opportunities to demonstrate what they can do, develop what they need to learn, and connect their skills with the right opportunities.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 pt-4">
              <button
                ...
                className="px-6 py-3.5 rounded-xl bg-emerald-400 hover:bg-emerald-300 text-slate-950 text-xs sm:text-sm font-bold shadow-lg shadow-emerald-950/40 hover:shadow-emerald-950/60 transition-all flex items-center gap-2 cursor-pointer"
              >
      ...
      <section id="who-we-are" aria-label="Who We Are" className="py-16 sm:py-24 bg-white border-b border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-4 mb-14">
            <span className="px-3.5 py-1.5 rounded-full bg-emerald-50 text-emerald-900 border border-emerald-200 text-xs font-bold uppercase tracking-wider">
              Who We Are
            </span>
            ...
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto">
              HUNAR is a skills-first career ecosystem designed to bring together Job Seekers, Employers, Skills, Learning, and Career opportunities into one cohesive experience.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto bg-slate-50 rounded-3xl p-6 sm:p-10 border border-slate-200/90 shadow-xs mb-14">
            <div className="space-y-4">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                HUNAR is engineered to go beyond bulletin boards. We create an integrated journey that connects practical skills, targeted learning, professional credentialing, and active hiring managers within a single platform.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            <h3 className="text-xs font-bold text-emerald-800 uppercase tracking-wider text-center mb-8">
              The HUNAR Career Journey
            </h3>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {/* Step 1 */}
              <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs hover:border-emerald-300 transition-colors relative flex flex-col justify-between">
                <div>
                  <div className="w-10 h-10 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-900 font-extrabold flex items-center justify-center text-sm mb-4">
                    01
                  </div>
      ...
      <section id="our-approach" aria-label="Our Approach" className="py-16 sm:py-24 bg-white border-b border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-4 mb-14">
            <span className="px-3.5 py-1.5 rounded-full bg-emerald-100 text-emerald-900 border border-emerald-200 text-xs font-bold uppercase tracking-wider">
              Guiding Principles
            </span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight">
            ...
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto">
              HUNAR organizes every platform feature, profile attribute, and matching mechanism around four core principles.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="p-6 sm:p-8 rounded-3xl bg-slate-50 border border-slate-200/90 shadow-xs hover:shadow-md transition-all flex flex-col justify-between">
              <div>
                <div className="text-xs font-black text-emerald-800 tracking-wider uppercase mb-3">
                  01 &mdash; Skills
                </div>
              ...
              <div className="mt-6 pt-4 border-t border-slate-200/60 text-xs font-semibold text-emerald-900">
      ...
      {/* ========================================================================= */}
      <section id="skills-first-philosophy" aria-label="Skills-First Philosophy" className="py-16 sm:py-24 bg-[#062e22] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto space-y-6 text-center">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-950 border border-emerald-500/30 text-emerald-300 text-xs font-bold uppercase tracking-wider">
          ...
          <div className="mt-14 max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <div className="p-6 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-xs">
              <div className="text-emerald-300 font-bold text-xs uppercase tracking-wider mb-2">Pillar 01</div>
            ...
            <div className="p-6 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-xs">
              <div className="text-emerald-300 font-bold text-xs uppercase tracking-wider mb-2">Pillar 02</div>
            ...
            <div className="p-6 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-xs">
              <div className="text-emerald-300 font-bold text-xs uppercase tracking-wider mb-2">Pillar 03</div>
            ...
            <div className="p-6 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-xs">
              <div className="text-emerald-300 font-bold text-xs uppercase tracking-wider mb-2">Pillar 04</div>
            ...
            <div className="p-6 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-xs">
              <div className="text-emerald-300 font-bold text-xs uppercase tracking-wider mb-2">Pillar 05</div>
            ...
            <div className="p-6 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-xs">
              <div className="text-emerald-300 font-bold text-xs uppercase tracking-wider mb-2">Pillar 06</div>
          ...
          <div className="mt-12 max-w-3xl mx-auto p-5 rounded-2xl bg-emerald-950/80 border border-emerald-500/30 text-center">
            <p className="text-xs sm:text-sm text-emerald-200/90 leading-relaxed">
              <strong>Our Objective:</strong> We do not claim to abolish traditional resumes or established hiring workflows overnight. Rather, HUNAR elevates verified skill evidence to the center of the conversation, creating stronger, fairer alignment between talented individuals and organizations.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-12 max-w-6xl mx-auto">
            ...
            <div className="lg:max-w-md space-y-4">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                HUNAR gives you the clarity, structure, and direct employer connections necessary to turn your demonstrated capabilities into a sustainable career.
              </p>
              <div className="pt-2">
                <button
      ...
      {/* ========================================================================= */}
      {/* 8. THE HUNAR ECOSYSTEM (VISUAL DIAGRAM) */}
      {/* ========================================================================= */}
      <section id="hunar-ecosystem" aria-label="The HUNAR Ecosystem" className="py-16 sm:py-24 bg-white border-b border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-4 mb-14">
            <span className="px-3.5 py-1.5 rounded-full bg-emerald-100 text-emerald-900 border border-emerald-200 text-xs font-bold uppercase tracking-wider">
          ...
          <div className="max-w-5xl mx-auto bg-slate-50 rounded-3xl p-6 sm:p-10 border border-slate-200 shadow-xs">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-2 relative">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-bold text-emerald-800 uppercase tracking-wider">Foundation</span>
                </div>
              ...
              <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-2 relative">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-bold text-emerald-800 uppercase tracking-wider">Currency</span>
                </div>
                <h4 className="text-base font-bold text-slate-900 flex items-center gap-2">
              ...
              <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-2 relative">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-bold text-emerald-800 uppercase tracking-wider">Preparation</span>
                </div>
                <h4 className="text-base font-bold text-slate-900 flex items-center gap-2">
                  <BookOpen className="w-4 h-4 text-emerald-600" />
                  <span>Learning</span>
              ...
              <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-2 relative">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-bold text-emerald-800 uppercase tracking-wider">Destination</span>
                </div>
                <h4 className="text-base font-bold text-slate-900 flex items-center gap-2">
              ...
              <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-2 relative">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-bold text-emerald-800 uppercase tracking-wider">Partners</span>
                </div>
                <h4 className="text-base font-bold text-slate-900 flex items-center gap-2">
              ...
              <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs space-y-2 relative">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-bold text-emerald-800 uppercase tracking-wider">Outcome</span>
                </div>
                <h4 className="text-base font-bold text-slate-900 flex items-center gap-2">
                  <TrendingUp className="w-4 h-4 text-emerald-600" />
            ...
            <div className="mt-8 pt-6 border-t border-slate-200 text-center">
              <p className="text-xs sm:text-sm text-slate-600 max-w-2xl mx-auto leading-relaxed">
                By integrating these components into one ecosystem, HUNAR ensures that learning leads to verifiable credentials, credentials lead to real interviews, and interviews lead to fulfilling, long-term careers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center space-y-4 mb-14">
              ...
              <p className="text-sm sm:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto">
                HUNAR's learning ecosystem is designed to ensure candidates are genuinely equipped to excel in the positions they apply for.
              </p>
            </div>
            ...
            <div className="mt-10 text-center">
              <button
                ...
                onClick={() => navigate('/learning')}
                className="px-6 py-3 rounded-xl bg-[#062e22] hover:bg-[#0b3b2c] text-white text-xs sm:text-sm font-bold shadow-xs transition-all inline-flex items-center gap-2 cursor-pointer"
              >
                <BookOpen className="w-4 h-4 text-emerald-300" />
      ...
      {/* ========================================================================= */}
      {/* 10. HOW HUNAR WORKS (6-STEP PROCESS) */}
      {/* ========================================================================= */}
      <section id="how-hunar-works" aria-label="How HUNAR Works" className="py-16 sm:py-24 bg-white border-b border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-4 mb-14">
            <span className="px-3.5 py-1.5 rounded-full bg-slate-200 text-slate-800 text-xs font-bold uppercase tracking-wider">
              Step-by-Step
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="p-8 sm:p-10 rounded-3xl bg-white border border-slate-200 shadow-xs space-y-6 flex flex-col justify-between">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 text-emerald-900 border border-emerald-200 text-xs font-bold uppercase tracking-wider">
            ...
            {/* Vision Card */}
            <div className="p-8 sm:p-10 rounded-3xl bg-gradient-to-br from-[#062e22] to-[#0d4131] text-white border border-emerald-900/60 shadow-md space-y-6 flex flex-col justify-between">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-950 text-emerald-300 border border-emerald-500/30 text-xs font-bold uppercase tracking-wider">
                ...
                <ul className="space-y-2.5 pt-2 text-xs sm:text-sm text-emerald-100/80">
                  <li className="flex items-start gap-2.5">
              ...
              <div className="pt-4 border-t border-emerald-800/60 text-xs text-emerald-300/70">
      ...
      {/* 13. WHY HUNAR */}
      {/* ========================================================================= */}
      <section id="why-hunar" aria-label="Why HUNAR" className="py-16 sm:py-24 bg-white border-b border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center space-y-4 mb-14">
            <span className="px-3.5 py-1.5 rounded-full bg-emerald-100 text-emerald-900 border border-emerald-200 text-xs font-bold uppercase tracking-wider">
              Distinct Advantages
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-14">
            ...
            <p className="text-xs sm:text-sm text-slate-600 max-w-xl mx-auto">
              Everything you need to know about HUNAR, our skills-first philosophy, and our platform operations.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  {isOpen && (
                    <div
                      id={`faq-answer-${index}`}
                      className="px-5 pb-5 pt-1 text-xs sm:text-sm text-slate-600 leading-relaxed border-t border-slate-100 animate-fadeIn"
                    >
                      {item.answer}
                    </div>
                  )}
      ...
      {/* ========================================================================= */}
      <section id="about-final-cta" aria-label="Join HUNAR" className="py-16 sm:py-24 bg-gradient-to-br from-[#062e22] via-[#093527] to-[#0d4131] text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-950/90 border border-emerald-500/30 text-emerald-300 text-xs font-bold">
          ...
          <p className="text-xs sm:text-sm lg:text-base text-emerald-100/90 max-w-2xl mx-auto leading-relaxed">
            Whether you're building your career or building your team, HUNAR is designed to connect skills with opportunity.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <button
              ...
              onClick={() => navigate('/jobs')}
              className="px-7 py-3.5 rounded-xl bg-emerald-400 hover:bg-emerald-300 text-slate-950 text-xs sm:text-sm font-bold shadow-lg shadow-emerald-950/40 hover:shadow-emerald-950/60 transition-all flex items-center gap-2 cursor-pointer"
            >
              <Briefcase className="w-4 h-4 text-emerald-950" />
              <span>Find Jobs</span>
              <ArrowRight className="w-4 h-4" />
